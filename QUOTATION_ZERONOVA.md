...
|------|-------------|------|
| **Interactive Demo** | Working prototype with sample data: Home, Opportunities list, Event detail, NGO profile, Login/Register flows, Basic dashboard layouts | **₹5,000** |

*Demo cost is separate and can be deducted from the selected plan if you proceed with development.*
...
| Item | Amount |
|------|--------|
| Development (Phase 1) | ₹95,000 |
| **Total Plan 2** | **₹95,000** |

---

## Plan 3: Complete (Phase 1 + Phase 2)

**Ideal for:** Full platform with volunteer engagement, messaging, and Impact Lab.
...
- Deployment in your accounts
- Deployment and environment setup documentation
- 1 month of post-launch bug fixes and maintenance
...
*All services will be set up in your accounts. You retain full ownership.*

---

## Assumptions

- Client provides access to GitHub, Vercel, MongoDB Atlas, and Firebase projects
- Content (copy, images) provided by client or placeholder used
- Scope limited to features listed; new features quoted separately
- Payment terms as agreed (e.g. milestone-based or upfront)

---

## Exclusions

- Third-party API integrations not specified in the plan
- Custom design/branding beyond the agreed design system
- Ongoing hosting or service subscription costs (Vercel, MongoDB, Firebase)
- Content creation, copywriting, or marketing
...
5. Development begins as per agreed timeline
